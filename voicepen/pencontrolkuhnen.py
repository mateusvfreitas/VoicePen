...
try:
    ...
    print("pigpio necessario para funcionar")
...
class BrachioGraph:
    ...
    def __init__(
        ...
        servo_1_centre=1700,        # Angulo inicial do Ombro
        ...
        arm_1_centre=-45,           # posicao da caneta na inicializacao
        arm_2_centre=90,            # posicao da caneta na inicializacao
        ...
        bounds=[-8, 6, 0, 12],      # Area máxima de desenho permitida (Retangulo) = xi = -8, xf = 0, yi = 6, yf = 12
...
#        lines = self.rotate_and_scale_lines(lines=lines, bounds=bounds, flip=True)
        ...
        # Começa o processo de escrita, linha por linha e mostra barra de progresso com tdqm. tem como tirar esses tqdm daqui? eh utilizado pra mostrar as barrinhas de progresso, ams pra gente vai ser irrelevante por nao ter monitor pra acompanhar o desenho. foi util durante a fase de testes, mas nao precisa mais
...
class Pen:
    ...
    def __init__(self, bg, pw_up=1700, pw_down=1300, pin=18, transition_time=0.25):
